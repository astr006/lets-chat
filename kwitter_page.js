//YOUR FIREBASE LINKS
var firebaseConfig = { apiKey: "AIzaSyDcp-AKtKNdrIcXsAjWhxyXr3h0_yIXvoU", authDomain: "kwitter-app-25f36.firebaseapp.com", databaseURL: "https://kwitter-app-25f36-default-rtdb.firebaseio.com", projectId: "kwitter-app-25f36", storageBucket: "kwitter-app-25f36.appspot.com", messagingSenderId: "245015283965", appId: "1:245015283965:web:7d6588cfae052ec53ed694", measurementId: "G-V24MTCZ2T8" }; user_name = localStorage.getItem("user_name"); room_name = localStorage.getItem("room_name"); function send() { msg = document.getElementById("msg").value; firebase.database().ref(room_name).push({ name:user_name, message:msg, like:0 }); document.getElementById("msg").value = ""; }
